...
post_harvest <- function(acs_dat) {
  
  # Black Vector #
  black <- acs_dat %>%
    dplyr::select(med_hh_inc_black, 
                  pct_hh_inc_black_100p,
                  pct_hh_inc_black_125p,
                  pct_snap_black,
                  pct_black_below_poverty,
