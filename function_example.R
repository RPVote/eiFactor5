# ACS Grab Function # 
# Function Name: acs_factor5 #

rm(list=ls())
# Arguments: 
# vars: Character/string vector of ACS variable names, 
# e.g. "B01001A_001", or c("B01001A_001", "B01001A_002")

source("~/Dropbox/collingwood_research/pols_nm/spring_2023/pols512/code/acs_vars.R")
...
acs_factor5 <- function(vars, 
  ...
  acs20_state_final <- acs20_state %>%
    mutate(tot_pop= B01003_001E,
           ...
           inc_total_households_black = B19001B_001E, 
